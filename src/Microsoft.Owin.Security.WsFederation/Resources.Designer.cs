...
namespace Microsoft.Owin.Security.WsFederation {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The WsFederation sign-in redirect uri is not well formed: &apos;{0}&apos;.
        /// </summary>
        internal static string Exception_InvalidSignInUri {
            get {
                return ResourceManager.GetString("Exception_InvalidSignInUri", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to The WsFederation sign-out redirect uri is not well formed: &apos;{0}&apos;.
        /// </summary>
        internal static string Exception_InvalidSignOutUri {
            get {
                return ResourceManager.GetString("Exception_InvalidSignOutUri", resourceCulture);
            }
        }
