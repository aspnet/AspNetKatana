// <copyright file="OAuthBearerAuthenticationExtensions.cs" company="Microsoft Open Technologies, Inc.">
...
namespace Owin
{
    public static class OAuthBearerAuthenticationExtensions
    {
        ...
        {
            app.Use(typeof(OAuthBearerAuthenticationMiddleware), options);
            return app;
        }
    }
}
