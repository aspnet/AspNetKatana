...
namespace Microsoft.Owin.Security.OpenIdConnect
{
    ...
    public class OpenIdConnectAuthenticationHandler : AuthenticationHandler<OpenIdConnectAuthenticationOptions>
    {
        ...
        /// <summary>
        /// Sets <see cref="OpenIdConnectMessage.Nonce"/> to see Options.ProtocolValidator.GenerateNonce.
        /// </summary>
        /// <param name="message">the <see cref="OpenIdConnectMessage"/> being processed.</param>
        /// <remarks>Calls <see cref="RememberNonce"/> to add the nonce to a protected cookie.</remarks>
