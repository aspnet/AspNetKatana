// <copyright file="HttpContextBaseExtensions.net45.cs" company="Microsoft Open Technologies, Inc.">
...
namespace System.Web
{
    public static partial class HttpContextBaseExtensions
    {
        ...
        /// <returns></returns>
        public static async Task<IEnumerable<AuthenticationResult>> Authenticate(this HttpContextBase context,
        ...
        /// <returns></returns>
        public static async Task<ClaimsIdentity> Authenticate(this HttpContextBase context, string authenticationType)
        {
        ...
        public static void SignIn(this HttpContextBase context, IEnumerable<Claim> claims, string nameClaimType, string roleClaimType, bool isPersistent)
        {
